...
//    elgamal_pub.pop_back();
    ...
    std::vector <mpz_class> elgamal_pri = {mpz_class("674396915767399126847577835082101185163744384861202856634666173662323559993170265329273708896869586870964508182895809168214525424504917634225790325485298", 16)};
...
//
    ...
    pri_key.set_packets({&sec, &uid, &sig});
    std::cout << pri_key.write() << std::endl;
