...
TEST(PGPTest, test_gpg_public_key) {
    ...
    // pubkey
    {
        ...
        EXPECT_EQ(n.get_str(2).size(), 2048);  // 2048-bit
        EXPECT_EQ(n.get_str(16), "");
        EXPECT_EQ(e.get_str(2).size(), 17);    // 17-bit
        EXPECT_EQ(e, 0x10001);
    }
    ...
    // pubsig
    {
        ...
        EXPECT_EQ(mpi[0].get_str(2).size(), 2047); // 2047-bit
        EXPECT_EQ(mpi[0].get_str(16), "");
        // pubsig/hashed
    ...
    // subkey
    {
        ...
        auto n = mpi[0], e = mpi[1];
        EXPECT_EQ(n.get_str(2).size(), 2048);  // 2048-bit
        EXPECT_EQ(n.get_str(16), "");
        EXPECT_EQ(e.get_str(2).size(), 17);    // 17-bit
        EXPECT_EQ(e, 0x10001);
    }
    ...
    // subsig
    {
        ...
        EXPECT_EQ(subsig->get_mpi()[0].get_str(2).size(), 2047); // 2047-bit
...
TEST(PGPTest, test_gpg_private_key) {
    ...
    // seckey
    {
        ...
        EXPECT_EQ(secmpi[0].get_str(16), "");
        EXPECT_EQ(secmpi[1].get_str(16), "");
        EXPECT_EQ(secmpi[2].get_str(16), "");
        EXPECT_EQ(secmpi[3].get_str(16), "");
    }
    ...
    // subkey
    {
        ...
        EXPECT_EQ(secmpi.size(), 4);
        EXPECT_EQ(secmpi[0].get_str(16), "");
        EXPECT_EQ(secmpi[1].get_str(16), "");
        EXPECT_EQ(secmpi[2].get_str(16), "");
        EXPECT_EQ(secmpi[3].get_str(16), "547d7351f3047b5d4728cfed246eef218e4d0840d5f5edb9faf723da93bbb914e806a8ea569889eada1a37a6dd69da1c7f6f2e21d8fc6622dc759adb97a3e4003fcd7a499bcecebf9b7f4be958c3486501810ce321b2c343d1d19aae7f6b6454b5a7a5c551986f49e904b63a6f7cc32ccafa78bb7a7696d627ba67489cdcc89");
    }
...
TEST(PGPTest, test_gpg_revoke) {
    ...
    auto sign = mpi[0];
    EXPECT_EQ(sign.get_str(2).size(), 2045);
    EXPECT_EQ(sign.get_str(16), "");
...
TEST(PGPTest, test_gpg_pka_encrypt_anonymous) {
    ...
    // tag1
    {
        ...
        auto key = mpi[0];
        EXPECT_EQ(key.get_str(2).size(), 2047);
        EXPECT_EQ(key.get_str(16), "");
    }
    // tag18
    {
...
TEST(PGPTest, test_gpg_pka_encrypt) {
    ...
    // tag1
    {
        ...
        auto key = mpi[0];
        EXPECT_EQ(key.get_str(2).size(), 2048);
        EXPECT_EQ(key.get_str(16), "");
    }
    // tag18
    {
...
TEST(PGPTest, test_gpg_symmetric_encrypt) {
    ...
    // tag1
    {
        ...
        auto key = mpi[0];
        EXPECT_EQ(key.get_str(2).size(), 2046);
        EXPECT_EQ(key.get_str(16), "");
    }
    // tag3
    {
...
TEST(PGPTest, test_gpg_clearsign) {
    ...
    ASSERT_EQ(mpi.size(), 1);
    auto sign = mpi[0];
    EXPECT_EQ(sign.get_str(2).size(), 2047);
    EXPECT_EQ(sign.get_str(16), "");
