...
const std::map <uint8_t, std::string> Tag2Subpacket::NAME = {
    ...
    std::make_pair(Tag2Subpacket::SIGNATURE_CREATION_TIME,                         "Signature Creation Time"),
    std::make_pair(Tag2Subpacket::SIGNATURE_EXPIRATION_TIME,                       "Signature Expiration Time"),
    std::make_pair(Tag2Subpacket::EXPORTABLE_CERTIFICATION,                        "Exportable Certification"),
    std::make_pair(Tag2Subpacket::TRUST_SIGNATURE,                                 "Trust Signature"),
    std::make_pair(Tag2Subpacket::REGULAR_EXPRESSION,                              "Regular Expression"),
    std::make_pair(Tag2Subpacket::REVOCABLE,                                       "Revocable"),
    std::make_pair(8,                                                              "Reserved"),
    std::make_pair(Tag2Subpacket::KEY_EXPIRATION_TIME,                             "Key Expiration Time"),
    std::make_pair(Tag2Subpacket::PLACEHOLDER_FOR_BACKWARD_COMPATIBILITY,          "Placeholder for Backward Compatibility"),       // No Format Defined
    std::make_pair(Tag2Subpacket::PREFERRED_SYMMETRIC_ALGORITHMS,                  "Preferred Symmetric Algorithms"),
    std::make_pair(Tag2Subpacket::REVOCATION_KEY,                                  "Revocation Key"),
    std::make_pair(13,                                                             "Reserved"),
    std::make_pair(14,                                                             "Reserved"),
    std::make_pair(15,                                                             "Reserved"),
    std::make_pair(Tag2Subpacket::ISSUER,                                          "Issuer"),
    std::make_pair(17,                                                             "Reserved"),
    std::make_pair(18,                                                             "Reserved"),
    std::make_pair(19,                                                             "Reserved"),
    std::make_pair(Tag2Subpacket::NOTATION_DATA,                                   "Notation Data"),
    std::make_pair(Tag2Subpacket::PREFERRED_HASH_ALGORITHMS,                       "Preferred Hash Algorithms"),
    std::make_pair(Tag2Subpacket::PREFERRED_COMPRESSION_ALGORITHMS,                "Preferred Compression Algorithms"),
    std::make_pair(Tag2Subpacket::KEY_SERVER_PREFERENCES,                          "Key Server Preferences"),
    std::make_pair(Tag2Subpacket::PREFERRED_KEY_SERVER,                            "Preferred Key Server"),
    std::make_pair(Tag2Subpacket::PRIMARY_USER_ID,                                 "Primary User ID"),
    std::make_pair(Tag2Subpacket::POLICY_URI,                                      "Policy URI"),
    std::make_pair(Tag2Subpacket::KEY_FLAGS,                                       "Key Flags"),
    std::make_pair(Tag2Subpacket::SIGNERS_USER_ID,                                 "Signer's User ID"),
    std::make_pair(Tag2Subpacket::REASON_FOR_REVOCATION,                           "Reason for Revocation"),
    std::make_pair(Tag2Subpacket::FEATURES,                                        "Features"),
    std::make_pair(Tag2Subpacket::SIGNATURE_TARGET,                                "Signature Target"),
    std::make_pair(Tag2Subpacket::EMBEDDED_SIGNATURE,                              "Embedded Signature"),
